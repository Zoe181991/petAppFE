  ...
  return (
    ...
    <div className='main-container'>
      <Stack minW='10em' spacing={4} width={['100%', '100%', '90%']} align='center'
        ...
        <Stack className='main-font' p={6} bgColor='gray.100' wrap={true} width={['100%', '100%', '90%']} borderRadius='md'>
      ...
      <Modal fontClass='font' isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalCloseButton />
          <ModalBody>
            <Text fontWeight='medium' className='main-font'>Are you sure you want to delete {user?.first_name} {user?.last_name}, Id: {user?._id} ?</Text>
