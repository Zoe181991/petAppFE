...
function UserProfile() {
  ...
  const [phone, setPhone] = useState(
    loggedInUser ? loggedInUser.phone_number : "",
  );
  ...
  const updateUser = async (formData) => {
    try {
      ...
      toast({
        ...
        render: () => (
          <ToastBox
            text={`  The user ${firstName} ${lastName} was updated successfully ✅`}
          />
        ),
        isClosable: true,
      });
          ...
          <CardHeader>
            ...
            >
              <Flex flex="1" gap="2" alignItems="center" flexWrap="wrap">
                ...
                <Stack>
                  <Text fontSize="1.5em" className="font-weird">
                    {firstName} {lastName}
                  </Text>
                  <Text fontSize="1em" className="main-font">
